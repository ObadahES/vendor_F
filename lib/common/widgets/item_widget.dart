                  ...
                  ? PopupMenuButton<String>(
                      onSelected: (String result) {
                        if (result == '1') {
                          ...
                          // Defensive checks to avoid RangeError
                          final profileModel =
                              Get.find<ProfileController>().profileModel;
                          final stores = profileModel?.stores;
                          final hasItemSection = stores != null &&
                              stores.isNotEmpty &&
                              stores[0].itemSection == true;
                          if (hasItemSection && item.id != null) {
                            Get.find<StoreController>()
                              ...
                              if (itemDetails != null) {
                                ...
                                showCustomSnackBar('item_details_not_found'.tr);
                              }
                            });
                          } else {
                            showCustomSnackBar(
