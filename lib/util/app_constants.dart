...
class AppConstants {
  ...
  static const String baseUrl = 'http://192.168.137.1/laravel-markets-project';
  ...
  static const String updateBankInfoUri = '/api/v1/vendor/update-itemListbank-info';
  ...
  static const String subCategoryProducts =
      '/api/v1/vendor/categories/sub-category-products';
